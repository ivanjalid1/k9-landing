        ...
        <div className="max-w-[1240px] mx-auto px-[clamp(20px,5vw,60px)]">
          <div className="grid grid-cols-2 gap-20 items-start max-md:grid-cols-1 max-md:gap-12">
            ...
            <div>
              ...
              <h1 className="font-[family-name:var(--font-landing-display)] text-[clamp(3rem,6vw,4.5rem)] tracking-[0.04em] text-white leading-none mb-6">
                LET'S TALK<br />ABOUT YOUR PET
              </h1>
              <p className="text-[1rem] font-light text-white/50 leading-[1.8] mb-10 max-w-[400px]">
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-center gap-4">
                  <div className="w-11 h-11 flex items-center justify-center bg-[rgba(232,168,56,0.1)] border border-[rgba(232,168,56,0.2)] text-[#E8A838]">
                  ...
                  <div>
                    <div className="text-[0.82rem] font-medium text-white/80">Service Area</div>
                    <div className="text-[0.88rem] font-light text-white/50">Halton &amp; Surrounding Areas, Ontario</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-11 h-11 flex items-center justify-center bg-[rgba(232,168,56,0.1)] border border-[rgba(232,168,56,0.2)] text-[#E8A838]">
                  ...
                  <div>
                    <div className="text-[0.82rem] font-medium text-white/80">Email</div>
                    <div className="text-[0.88rem] font-light text-white/50">info@k9movement.ca</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-11 h-11 flex items-center justify-center bg-[rgba(232,168,56,0.1)] border border-[rgba(232,168,56,0.2)] text-[#E8A838]">
                  ...
                  <div>
                    <div className="text-[0.82rem] font-medium text-white/80">Phone</div>
                    <div className="text-[0.88rem] font-light text-white/50">(905) 555-K9MV</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-6 max-[480px]:grid-cols-1">
                <button
                  ...
                  className={`flex flex-col items-center gap-2 p-5 border transition-all duration-300 cursor-pointer ${
                    status !== 'booking'
                      ? 'bg-[rgba(232,168,56,0.08)] border-[#E8A838] text-white'
                      : 'bg-transparent border-white/10 text-white/50 hover:border-white/30'
                  }`}
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#E8A838]"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                  <span className="text-[0.82rem] font-bold tracking-[0.1em] uppercase">Ask a Question</span>
                  <span className="text-[0.72rem] text-white/40 font-light">Have a question? Send us a message</span>
                </button>
                <a
                  href="#intake"
                  className={`flex flex-col items-center gap-2 p-5 border border-white/10 text-white/50 hover:border-[#E8A838] hover:text-white hover:bg-[rgba(232,168,56,0.08)] transition-all duration-300`}
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#E8A838]"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                  <span className="text-[0.82rem] font-bold tracking-[0.1em] uppercase">Book a Service</span>
                  <span className="text-[0.72rem] text-white/40 font-light">Ready? Start your application now</span>
                </a>
              </div>
              ...
              {status === 'sent' ? (
                ...
                <form onSubmit={handleSubmit} className="bg-[#151515] border border-white/10 p-10 max-md:p-7">
                  <h2 className="font-[family-name:var(--font-landing-display)] text-[1.6rem] tracking-[0.1em] text-white mb-8">
                    SEND US A MESSAGE
                  </h2>

                  {errorMsg && (
                    <div className="mb-6 px-4 py-3 bg-[rgba(200,50,50,0.1)] border border-[rgba(200,50,50,0.3)] text-[0.85rem] text-red-400">
                      {errorMsg}
                    </div>
                  )}
                  ...
                  {/* Name */}
                  <div className="mb-5">
                    <label className="block text-[0.78rem] font-medium tracking-[0.08em] uppercase text-white/60 mb-2">
                      Full Name <span className="text-[#E8A838]">*</span>
                    </label>
                    <input
                      type="text"
                      value={form.name}
                      ...
                      className="w-full bg-[#0a0a0a] border border-white/10 px-4 py-3.5 text-[0.92rem] text-white placeholder-white/25 outline-none focus:border-[#E8A838] transition-colors duration-300"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-5 max-[480px]:grid-cols-1">
                    <div>
                      <label className="block text-[0.78rem] font-medium tracking-[0.08em] uppercase text-white/60 mb-2">
                        Email <span className="text-[#E8A838]">*</span>
                      </label>
                      <input
                        type="email"
                        value={form.email}
                  ...
                  <div className="mb-5">
                    <label className="block text-[0.78rem] font-medium tracking-[0.08em] uppercase text-white/60 mb-2">
                      Service Interested In <span className="text-[#E8A838]">*</span>
                    </label>
                    <select
                      value={form.service}
                      onChange={(e) => update('service', e.target.value)}
                      className="w-full bg-[#0a0a0a] border border-white/10 px-4 py-3.5 text-[0.92rem] text-white outline-none focus:border-[#E8A838] transition-colors duration-300 appearance-none cursor-pointer"
                      style={{
                        backgroundImage: `url("data:image/svg+xml,%3Csvg width='12' height='8' viewBox='0 0 12 8' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M1 1.5L6 6.5L11 1.5' stroke='%23E8A838' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E")`,
                  ...
                  <div className="mb-8">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full bg-[#0a0a0a] border border-white/10 px-4 py-3.5 text-[0.92rem] text-white placeholder-white/25 outline-none focus:border-[#E8A838] transition-colors duration-300 resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center gap-2.5 bg-[#E8A838] text-[#0a0a0a] text-[0.88rem] font-bold tracking-[0.15em] uppercase py-[18px] border-2 border-[#E8A838] hover:bg-[#F0B840] hover:shadow-[0_0_40px_rgba(232,168,56,0.2)] transition-all duration-400 disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {status === 'sending' ? (
                      <>
                        <span className="inline-block w-[18px] h-[18px] border-2 border-[#0a0a0a]/30 border-t-[#0a0a0a] rounded-full animate-spin" />
                        Sending...
                      </>
                    ) : (
                      <>
